      ...
      <section className="container" style={{ padding: '8rem 2rem' }}>
        <div style={{ maxWidth: '800px' }}>
          ...
          <p style={{ fontSize: '1.2rem', opacity: 0.8, marginBottom: '2rem' }}>
            We help B2B companies solve complex marketing challenges through high-performance websites.
            In a world of generic agencies, we specialize in the unique needs of the B2B sector.
          </p>
          <p style={{ fontSize: '1.2rem', opacity: 0.8 }}>
            Our team combines strategy, design, and engineering to deliver results that matter:
            more leads, better conversions, and measurable growth.
          </p>
        </div>
      </section>
